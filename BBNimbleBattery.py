#Battle Brothers Damage Calculator -- Nimble Battery Version 1.2.4:
...
#This version of the calculator will run 12 different Nimble lines given the scenario you provide.
...
#IMPORTANT: In this version of the calculator, the other defender stats do not need to be set. If you want your input run in the script then set the next flag.
Use_My_Input = 0 #Set to 1 if you want your input used and 0 otherwise. For example, if you have famed armor you want to test then put it here. Common Nimble lines will run regardless.
Def_Helmet = 250
Def_Armor = 200   
Fatigue = -16    #Fatigue value only effects Nimble.
