#Battle Brothers Damage Calculator -- Hit Chance Version 1.7.0:
...
for i in range(0,Trials): #This will run a number of trials as set above by the trials variable.
    ...
    while hp > 0: #Continue looping until death.
        ...
        #SplitMan secondary hits: The following code block accounts for the extra hit for SplitMan. This will only run if the primary attack didn't miss.
        if SplitMan == 1 and (SplitManBodyFollowUp == 1 or SplitManHeadFollowUp == 1):
