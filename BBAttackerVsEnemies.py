#Battle Brothers Damage Calculator -- Attacker Vs. Enemies Version 1.7.0:
...
#Weapon Type: #Set these to enable Ancient Dead resistances. It will not affect other enemies.
...
def calc():
    global Headshotchance,total,HHStack,Ignore
