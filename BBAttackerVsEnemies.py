#Battle Brothers Damage Calculator -- Attacker Vs. Enemies Version:
...
Mind = 50        #Mind = 55
Maxd = 70        #Maxd = 80
Headchance = 25  #Headchance = 30
Ignore = 35      #Ignore = 30
ArmorMod = 65   #ArmorMod = 125
...
HHCarryOver = 1         #Uncheck regular HH if you use this. Causes HeadHunter stacks to carry over to subsequent trials rather than resetting to better approximate how HH really works.
